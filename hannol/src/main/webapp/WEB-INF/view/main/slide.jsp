...
<style>
	.assetsContents{text-align:center; margin-top: 60px}
	.assets_box{display:inline-block; position:relative; width:23%; margin-left:1.5%; border:1px solid #d5d5d5; border-radius:3px;}    
	...
	.assets_box dt img{width:100%; max-height: 250px;}  
	.assets_box dd{position:relative; padding:30px; text-align:left; color:#666666;}
 	...
 	.running_time{display:inline-block; position:relative; width:23%; margin-left:1.5%; border:1px solid #d5d5d5; border-radius:3px;}
 	.running_time dt img{width:100%; max-height: 250px;}
 	.running_time dd{position:relative; padding:30px; text-align:left; color:#666666;}
 	.running_time .as_title{margin-top:20px; font-size:19px; font-weight:700;} 
 	.running_time .as_subTitle{margin-top:2px;} 
</style>
...
<div class="main_content">
	<div class="container">
		...
		<dl id="stroller" class="assets_box facility" onclick="javascript:location.href='<%=cp%>/reservation/ticket'">
			<dt>
		...
		<dl id="wheelchair" class="assets_box facility" onclick="javascript:location.href='<%=cp%>/magicPass/booking'">
			<dt>
		...
		<dl id="storageBox" class="assets_box" onclick="javascript:location.href='<%=cp%>/todayPark/rides'">
			<dt>
