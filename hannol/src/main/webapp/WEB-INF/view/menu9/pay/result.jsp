	    ...
	    <table class="custom_table" style="margin-top: 30px;">
		  	<tbody>
				<tr>
					...
					<td class="table_td">${dto.payPrice}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="table_td">${dto.curDate}</td>
				</tr>
		  	</tbody>
		</table>
		...
		<table style="width: 100%; margin: 20px auto; border-spacing: 0px;">
		   	<tr height="40">
		      	<td align="center" width="100">
		          	<button type="button" class="btn btn-danger" style="font-weight: bold;" onclick="javascript:location.href='<%=cp%>/pay/history'">구매내역 확인</button>
