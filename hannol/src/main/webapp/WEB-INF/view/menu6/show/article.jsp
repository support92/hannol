...
<div class="bodyFrame2">
    ...
    <br><br>
    	...
    	<c:if test="${not empty dto.saveLocFilename}"><img src="<%=cp%>/resource/uploads/facility/${dto.saveLocFilename}"  style="padding: 5px;" onerror="this.src='<%=cp%>/resource/images/noimage.png'"></c:if>
    </div>
    <br><br><br>
