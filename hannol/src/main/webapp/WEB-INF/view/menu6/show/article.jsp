...
<div class="bodyFrame2">
    ...
    <br><br>
    	...
    	<c:if test="${empty dto.saveFilename}"><img src="<%=cp%>/resource/images/noimage.png"  style="padding: 5px;" onerror="this.src='<%=cp%>/resource/images/noimage.png'"></c:if>
    	<c:if test="${not empty dto.saveLocFilename}"><img src="hannolAdmin/resource/uploads/facility/${dto.saveLocFilename}"  style="padding: 5px;" onerror="this.src='<%=cp%>/resource/images/noimage.png'"></c:if>
    </div>
    <br><br><br>
